...
*/
    ...
    const requestResult = await createCallRequestWithCustomerLock({
      ...
      insertParams: [astrologerId, userId, maxDurationSec, audioRate, platformFee],
    });
...
*/
    ...
    const requestResult = await createCallRequestWithCustomerLock({
      ...
      insertParams: [astrologerId, userId, maxDurationSec, videoRate, platformFee],
    });
...
*/
    ...
    const requestResult = await createCallRequestWithCustomerLock({
      ...
      insertSql: `INSERT INTO call_requests
        (astrologer_id, customer_id, call_type, max_duration_sec, call_charge, platform_fee, status)
        VALUES (?, ?, 'chat', ?, ?, ?, 'pending')`,
      insertParams: [astrologerId, userId, maxDurationSec, chatRate, platformFee],
    });
