...
import {
  ...
  getStatus, getCallRequestsWithCustomer, rejectCallRequest, acceptCall, endCall, getChatListByUser,getChatMessages,selfanalysis
...
router.get("/selfanalysis/:astrologer_id", selfanalysis);
